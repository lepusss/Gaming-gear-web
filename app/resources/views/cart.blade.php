...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="assets1/css/custom.css"/>		
	</head>
	...
	<body>
		...
		<div class="container text-center">
			...
			<div class="col-md-7 col-sm-12 text-left">
				<ul>
					...
					<li class="row">
						...
						<span class="itemName">Black Widow 3</span>
						<span class="popbtn"><a class="arrow"></a></span>
						<span class="price">$49.95</span>
					</li>
					<li class="row">
						<span class="quantity">1</span>
						<span class="itemName">Akko 5075B</span>
						<span class="popbtn"><a class="arrow"></a></span>
						<span class="price">$5.00</span>
					</li>
					<li class="row">
						<span class="quantity">2</span>
						<span class="itemName">DareU EK1280s Pink White</span>
						<span class="popbtn"><a class="arrow"></a></span>
						<span class="price">$919.99</span>				
					</li>
					<li class="row">
						<span class="quantity">1</span>
						<span class="itemName">ProArt PA248QV-P</span>
						<span class="popbtn"><a class="arrow"></a></span>
            ...
            <span class="order"> <a class="text-center" href="/">Back</a></span>
					</li>
				</ul>
			</div>
