        ...
        <div id="main_content">
          <div id="menu_tab">
            ...
            <ul class="menu">
              ...
              <li class="divider"></li>
              <li><a href="{{'adLogin'}}" class="nav4">Log In</a></li>
              <li class="divider"></li>
          ...
          <div class="center_content">
              ...
              <div class="prod_box_big">
                  ...
                  <div class="center_prod_box_big">
                    <div class="product_img_big"> <a href="javascript:popImage('images/big_pic.jpg','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="image/{{$product->proImage}}" alt="" border="0" /></a>
