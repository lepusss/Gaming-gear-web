  ...
  <div id="main_content">
    ...
    <div class="center_content">
      ...
      <div class="prod_box">
        ...
        <div class="prod_details_tab"> <a href="{{url('add-to-cart/'.$pro->productID)}}" title="header=[Add to cart] body=[&nbsp;] fade=[on]"><img src="images/cart.gif" alt="" border="0" class="left_bt" /></a></div>
      </div>
      @endforeach
