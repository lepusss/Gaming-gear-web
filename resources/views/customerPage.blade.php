...
<div id="main_container">
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        <li><a href="{{'customerHome'}}" class="nav1"> Home</a></li>
        
        
        <li class="divider"></li>
        <li><a href="{{url('logout')}}" class="nav6">Log out</a></li>
        <li class="divider"></li>
      </ul>
    ...
    <div class="center_content">
        ...
        <div class="prod_box_big">
            ...
            <div class="center_prod_box_big">
              <div class="product_img_big"> <a href="javascript:popImage('images/big_pic.jpg','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="image/{{$data->avatar}}" alt="" border="0" width="160px" height="160px" /></a>
                
              </div>
              <div class="details_big_box">
                <div class="product_title_big">{{$data->customerName}}</div>
                <div class="specifications">Gender: <span class="blue">{{$data->customerGender}}</span><br />
                  Email: <span class="blue">{{$data->customerEmail}}</span><br />
                  Phone: <span class="blue">{{$data->customerPhone}}</span><br />
                  Address: <span class="blue">{{$data->customerAddress}}</span><br />
                </div>
