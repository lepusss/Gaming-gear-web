...
<head>
<title>Gaming Gear Store - Product Details</title>
    ...
    <div class="oferte_content">
      ...
      <div class="oferta">
        ...
        <div class="oferta_pagination">
          {{-- <nav area-label="Page navigation">{!! $products->links() !!}</nav>   --}}
        </div>
      </div>
      <div class="top_divider"><img src="../images/header_divider.png" alt="" width="1" height="164" /></div>
    </div>
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="{{url('adLogin')}}" class="nav4">Log In</a></li>
        <li class="divider"></li>
        <li><a href="{{url('registration')}}" class="nav5">Register</a></a></li>
        <li class="divider"></li>
    ...
    <div class="center_content">
        ...
        <div class="prod_box_big">
            ...
            <div class="center_prod_box_big">
              <div class="product_img_big"> <a href="javascript:popImage('images/big_pic.jpg','Some Title')" title="header=[Zoom] body=[&nbsp;] fade=[on]"><img src="../image/{{$product->proImage}}" alt="" border="0" width="160px" height="160px" /></a>
                
              </div>
              <div class="details_big_box">
                <div class="product_title_big">{{$product->productName}}</div>
                <div class="specifications">Manufacturer: <span class="blue">{{$product->manufacturer->manufacturerName}}</span><br />
                  Category: <span class="blue">{{$product->category->catName}}</span><br />
                  Warranty: <span class="blue">{{$product->prowarranty}}</span><br />
                  Product Detail: <span class="blue">{{$product->productDetails}}</span><br />
                </div>
                <div class="prod_price_big"> <span class="price">${{$product->productPrice}}</span></div>
